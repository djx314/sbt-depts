...
val buildSbtFile2: File     = (`root/file` / ".." / "depts-project"/"scala-version-project" / "scala_212-project" / "build.sbt").getCanonicalFile
val buildSbtFile3: File     = (`root/file` / ".." / "depts-project"/"scala-version-project" / "scala_213-project" / "build.sbt").getCanonicalFile
val buildSbtFile4: File     = (`root/file` / ".." /"depts-project" /"scala-version-project" / "scala_3-project" / "build.sbt").getCanonicalFile
val buildSbtFile5: File     = (`root/file` / ".." / "depts-project"/"scala-version-project" / "java_version-project" / "build.sbt").getCanonicalFile
val buildPropertyFile: File = (`root/file` / ".." / "depts-project"/"scala-version-project" / "single-sbt-project" / "build.sbt").getCanonicalFile
