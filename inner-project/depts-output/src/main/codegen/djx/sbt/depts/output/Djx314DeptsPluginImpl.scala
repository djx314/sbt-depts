...
trait Djx314DeptsImpl {
  ...
  def settingsForDept: Seq[Setting[_]] = Seq(
    innerSetting.setDefault(libScalax.`typesafe-config`)(Seq.empty)(sourcePosition.fromEnclosing()),
    innerSetting.setDefault(libScalax.`http4s-Release-ember-server`)(Seq.empty)(sourcePosition.fromEnclosing()),
    innerSetting.setDefault(libScalax.`http4s-Release-ember-client`)(Seq.empty)(sourcePosition.fromEnclosing()),
    innerSetting.setDefault(libScalax.`scalatest`)(Seq.empty)(sourcePosition.fromEnclosing()),
    innerSetting.setDefault(libScalax.`scala-sbt`)(Seq.empty)(sourcePosition.fromEnclosing()),
    innerSetting.setDefault(libScalax.`fs2`)(Seq.empty)(sourcePosition.fromEnclosing()),
    innerSetting.setDefault(libScalax.`kind-projector`)(Seq.empty)(sourcePosition.fromEnclosing()),
    innerSetting.setDefault(libScalax.`simple-adt`)(Seq.empty)(sourcePosition.fromEnclosing()),
    innerSetting.setDefault(libScalax.`cats-effect`)(Seq.empty)(sourcePosition.fromEnclosing()),
    innerSetting.setDefault(libScalax.`scala-collection-compat`)(Seq.empty)(sourcePosition.fromEnclosing()),
    innerSetting.setDefault(libScalax.`commons-lang3-bridge`)(Seq.empty)(sourcePosition.fromEnclosing()),
    innerSetting.setDefault(libScalax.`http4s-twirl`)(Seq.empty)(sourcePosition.fromEnclosing()),
    innerSetting.setDefault(libScalax.`commons-lang3`)(Seq.empty)(sourcePosition.fromEnclosing()),
    innerSetting.setDefault(libScalax.`doobie`)(Seq.empty)(sourcePosition.fromEnclosing()),
    innerSetting.setDefault(libScalax.`zio-config`)(Seq.empty)(sourcePosition.fromEnclosing()),
    innerSetting.setDefault(libScalax.`slf4j-simple`)(Seq.empty)(sourcePosition.fromEnclosing()),
    innerSetting.setDefault(libScalax.`zio-json`)(Seq.empty)(sourcePosition.fromEnclosing()),
    innerSetting.setDefault(libScalax.`h2`)(Seq.empty)(sourcePosition.fromEnclosing()),
    innerSetting.setDefault(libScalax.`zio2`)(Seq.empty)(sourcePosition.fromEnclosing()),
    innerSetting.setDefault(libScalax.`http4s-Release`)(Seq.empty)(sourcePosition.fromEnclosing()),
    innerSetting.setDefault(libScalax.`sbt-librarymanagement-core`)(Seq.empty)(sourcePosition.fromEnclosing()),
    innerSetting.setDefault(libScalax.`shapeless3-test`)(Seq.empty)(sourcePosition.fromEnclosing()),
    innerSetting.setDefault(libScalax.`circe`)(Seq.empty)(sourcePosition.fromEnclosing()),
    innerSetting.setDefault(libScalax.`cats-effect-cps`)(Seq.empty)(sourcePosition.fromEnclosing()),
    innerSetting.setDefault(libScalax.`doobie-h2`)(Seq.empty)(sourcePosition.fromEnclosing()),
    innerSetting.setDefault(libScalax.`javacv-platform`)(Seq.empty)(sourcePosition.fromEnclosing()),
    innerSetting.setDefault(libScalax.`commons-io`)(Seq.empty)(sourcePosition.fromEnclosing()),
    innerSetting.setDefault(libScalax.`shapeless`)(Seq.empty)(sourcePosition.fromEnclosing()),
    innerSetting.setDefault(libScalax.`macwire`)(Seq.empty)(sourcePosition.fromEnclosing()),
    innerSetting.setDefault(libScalax.`cats`)(Seq.empty)(sourcePosition.fromEnclosing()),
