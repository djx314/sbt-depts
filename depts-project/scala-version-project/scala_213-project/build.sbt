...
libraryDependencies += "org.apache.pekko" %% "pekko-stream-typed"          % "1.3.0"
libraryDependencies += "org.apache.pekko" %% "pekko-http"                  % "1.3.0"
libraryDependencies += "org.apache.pekko" %% "pekko-http-spray-json"       % "1.3.0"
libraryDependencies += "org.apache.pekko" %% "pekko-serialization-jackson" % "1.3.0"
libraryDependencies += "org.apache.pekko" %% "pekko-slf4j"                 % "1.3.0"

VarContext.changeDeptVar                  := "pekko-actor"
libraryDependencies += "org.apache.pekko" %% "pekko-actor" % "1.3.0"
