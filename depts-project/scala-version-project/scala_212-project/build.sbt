...
libraryDependencies += "co.fs2" %%% "fs2-core"             % "3.12.1"
libraryDependencies += "co.fs2" %%% "fs2-io"               % "3.12.1"
libraryDependencies += "co.fs2"  %% "fs2-reactive-streams" % "3.12.1"
libraryDependencies += "co.fs2" %%% "fs2-scodec"           % "3.12.1"
