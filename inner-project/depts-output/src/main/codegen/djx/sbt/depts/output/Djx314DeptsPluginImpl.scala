...
val `jmh-generator-annprocess`: SettingKey[Seq[sbt.ModuleID]] = sbt.settingKey[Seq[sbt.ModuleID]]("""sbt library: jmh-generator-annprocess""")
...
val `javet-v8-windows-x86_64-i18n`: SettingKey[Seq[sbt.ModuleID]] = sbt.settingKey[Seq[sbt.ModuleID]]("""sbt library: javet-v8-windows-x86_64-i18n""")
val `javet-v8-windows-x86_64`: SettingKey[Seq[sbt.ModuleID]] = sbt.settingKey[Seq[sbt.ModuleID]]("""sbt library: javet-v8-windows-x86_64""")
val `javet-v8-macos-x86_64-i18n`: SettingKey[Seq[sbt.ModuleID]] = sbt.settingKey[Seq[sbt.ModuleID]]("""sbt library: javet-v8-macos-x86_64-i18n""")
val `javet-v8-macos-x86_64`: SettingKey[Seq[sbt.ModuleID]] = sbt.settingKey[Seq[sbt.ModuleID]]("""sbt library: javet-v8-macos-x86_64""")
val `javet-v8-macos-arm64-i18n`: SettingKey[Seq[sbt.ModuleID]] = sbt.settingKey[Seq[sbt.ModuleID]]("""sbt library: javet-v8-macos-arm64-i18n""")
val `javet-v8-macos-arm64`: SettingKey[Seq[sbt.ModuleID]] = sbt.settingKey[Seq[sbt.ModuleID]]("""sbt library: javet-v8-macos-arm64""")
val `javet-v8-linux-x86_64-i18n`: SettingKey[Seq[sbt.ModuleID]] = sbt.settingKey[Seq[sbt.ModuleID]]("""sbt library: javet-v8-linux-x86_64-i18n""")
val `javet-v8-linux-x86_64`: SettingKey[Seq[sbt.ModuleID]] = sbt.settingKey[Seq[sbt.ModuleID]]("""sbt library: javet-v8-linux-x86_64""")
val `javet-v8-linux-arm64-i18n`: SettingKey[Seq[sbt.ModuleID]] = sbt.settingKey[Seq[sbt.ModuleID]]("""sbt library: javet-v8-linux-arm64-i18n""")
val `javet-v8-linux-arm64`: SettingKey[Seq[sbt.ModuleID]] = sbt.settingKey[Seq[sbt.ModuleID]]("""sbt library: javet-v8-linux-arm64""")
val `javet-node-android-i18n`: SettingKey[Seq[sbt.ModuleID]] = sbt.settingKey[Seq[sbt.ModuleID]]("""sbt library: javet-node-android-i18n""")
val `javet-node-android`: SettingKey[Seq[sbt.ModuleID]] = sbt.settingKey[Seq[sbt.ModuleID]]("""sbt library: javet-node-android""")
val `javet-node-windows-x86_64-i18n`: SettingKey[Seq[sbt.ModuleID]] = sbt.settingKey[Seq[sbt.ModuleID]]("""sbt library: javet-node-windows-x86_64-i18n""")
val `javet-node-windows-x86_64`: SettingKey[Seq[sbt.ModuleID]] = sbt.settingKey[Seq[sbt.ModuleID]]("""sbt library: javet-node-windows-x86_64""")
val `javet-node-macos-x86_64-i18n`: SettingKey[Seq[sbt.ModuleID]] = sbt.settingKey[Seq[sbt.ModuleID]]("""sbt library: javet-node-macos-x86_64-i18n""")
val `javet-node-macos-x86_64`: SettingKey[Seq[sbt.ModuleID]] = sbt.settingKey[Seq[sbt.ModuleID]]("""sbt library: javet-node-macos-x86_64""")
val `javet-node-macos-arm64-i18n`: SettingKey[Seq[sbt.ModuleID]] = sbt.settingKey[Seq[sbt.ModuleID]]("""sbt library: javet-node-macos-arm64-i18n""")
val `javet-node-macos-arm64`: SettingKey[Seq[sbt.ModuleID]] = sbt.settingKey[Seq[sbt.ModuleID]]("""sbt library: javet-node-macos-arm64""")
val `javet-node-linux-x86_64-i18n`: SettingKey[Seq[sbt.ModuleID]] = sbt.settingKey[Seq[sbt.ModuleID]]("""sbt library: javet-node-linux-x86_64-i18n""")
val `javet-node-linux-x86_64`: SettingKey[Seq[sbt.ModuleID]] = sbt.settingKey[Seq[sbt.ModuleID]]("""sbt library: javet-node-linux-x86_64""")
val `javet-node-linux-arm64-i18n`: SettingKey[Seq[sbt.ModuleID]] = sbt.settingKey[Seq[sbt.ModuleID]]("""sbt library: javet-node-linux-arm64-i18n""")
val `javet-node-linux-arm64`: SettingKey[Seq[sbt.ModuleID]] = sbt.settingKey[Seq[sbt.ModuleID]]("""sbt library: javet-node-linux-arm64""")
...
val `simple-adt-bridge-support`: SettingKey[Seq[sbt.ModuleID]] = sbt.settingKey[Seq[sbt.ModuleID]]("""sbt library: simple-adt-bridge-support""")
...
val `scala-parser-combinators`: SettingKey[Seq[sbt.ModuleID]] = sbt.settingKey[Seq[sbt.ModuleID]]("""sbt library: scala-parser-combinators""")
...
val `zio-interop-reactivestreams`: SettingKey[Seq[sbt.ModuleID]] = sbt.settingKey[Seq[sbt.ModuleID]]("""sbt library: zio-interop-reactivestreams""")
...
val `sbt-librarymanagement-core`: SettingKey[Seq[sbt.ModuleID]] = sbt.settingKey[Seq[sbt.ModuleID]]("""sbt library: sbt-librarymanagement-core""")
...
val `http4s-Release-ember-client`: SettingKey[Seq[sbt.ModuleID]] = sbt.settingKey[Seq[sbt.ModuleID]]("""sbt library: http4s-Release-ember-client""")
val `http4s-Release-ember-server`: SettingKey[Seq[sbt.ModuleID]] = sbt.settingKey[Seq[sbt.ModuleID]]("""sbt library: http4s-Release-ember-server""")
val `http4s-Release`: SettingKey[Seq[sbt.ModuleID]] = sbt.settingKey[Seq[sbt.ModuleID]]("""sbt library: http4s-Release""")
val `scala-collection-compat`: SettingKey[Seq[sbt.ModuleID]] = sbt.settingKey[Seq[sbt.ModuleID]]("""sbt library: scala-collection-compat""")
