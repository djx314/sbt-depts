...
libScalax.`kind-projector` ++= { if (djxIsScala211.value) Seq( """org.typelevel""" % """kind-projector""" % """0.13.2""" cross CrossVersion.full) else Seq.empty }
,
...
libScalax.`zio2` ++= { if (djxIsScala211.value) Seq( """dev.zio""" %%% """zio""" % """2.0.9""") else Seq.empty }
,

libScalax.`zio2` ++= { if (djxIsScala211.value) Seq( """dev.zio""" %%% """zio-streams""" % """2.0.9""") else Seq.empty }
,

libScalax.`zio2` ++= { if (djxIsScala211.value) Seq( """dev.zio""" %%% """zio-test""" % """2.0.9""") else Seq.empty }
,

libScalax.`zio2` ++= { if (djxIsScala211.value) Seq( """dev.zio""" %%% """zio-test-sbt""" % """2.0.9""") else Seq.empty }
,

libScalax.`typesafe-config` ++= { if (djxIsScala211.value) Seq( """com.typesafe""" % """config""" % """1.4.2""") else Seq.empty }
,

libScalax.`scala-collection-compat` ++= { if (djxIsScala211.value) Seq( """org.scala-lang.modules""" %%% """scala-collection-compat""" % """2.9.0""") else Seq.empty }
,

libScalax.`http4s-Release` ++= { if (djxIsScala211.value) Seq( """org.http4s""" %%% """http4s-dsl""" % """0.23.17""") else Seq.empty }
,

libScalax.`http4s-Release` ++= { if (djxIsScala211.value) Seq( """org.http4s""" %%% """http4s-ember-server""" % """0.23.17""") else Seq.empty }
,

libScalax.`http4s-Release` ++= { if (djxIsScala211.value) Seq( """org.http4s""" %%% """http4s-ember-client""" % """0.23.17""") else Seq.empty }
,
...
libScalax.`binding.scala` ++= { if (djxIsScala211.value) Seq( """com.thoughtworks.binding""" %%% """binding""" % """12.1.0+110-53fd3428""") else Seq.empty }
,
...
libScalax.`commons-lang3` ++= { if (djxIsScala211.value) Seq( """org.apache.commons""" % """commons-lang3""" % """3.12.0""") else Seq.empty }
,

libScalax.`simple-adt` ++= { if (djxIsScala211.value) Seq( """net.scalax.simple""" %%% """simple-adt""" % """0.0.1-M6""") else Seq.empty }
,

libScalax.`kind-projector` ++= { if (djxIsScala212.value) Seq( """org.typelevel""" % """kind-projector""" % """0.13.2""" cross CrossVersion.full) else Seq.empty }
,
...
libScalax.`zio2` ++= { if (djxIsScala212.value) Seq( """dev.zio""" %%% """zio""" % """2.0.9""") else Seq.empty }
,

libScalax.`zio2` ++= { if (djxIsScala212.value) Seq( """dev.zio""" %%% """zio-streams""" % """2.0.9""") else Seq.empty }
,

libScalax.`zio2` ++= { if (djxIsScala212.value) Seq( """dev.zio""" %%% """zio-test""" % """2.0.9""") else Seq.empty }
,

libScalax.`zio2` ++= { if (djxIsScala212.value) Seq( """dev.zio""" %%% """zio-test-sbt""" % """2.0.9""") else Seq.empty }
,

libScalax.`typesafe-config` ++= { if (djxIsScala212.value) Seq( """com.typesafe""" % """config""" % """1.4.2""") else Seq.empty }
,

libScalax.`scala-collection-compat` ++= { if (djxIsScala212.value) Seq( """org.scala-lang.modules""" %%% """scala-collection-compat""" % """2.9.0""") else Seq.empty }
,

libScalax.`http4s-Release` ++= { if (djxIsScala212.value) Seq( """org.http4s""" %%% """http4s-dsl""" % """0.23.17""") else Seq.empty }
,

libScalax.`http4s-Release` ++= { if (djxIsScala212.value) Seq( """org.http4s""" %%% """http4s-ember-server""" % """0.23.17""") else Seq.empty }
,

libScalax.`http4s-Release` ++= { if (djxIsScala212.value) Seq( """org.http4s""" %%% """http4s-ember-client""" % """0.23.17""") else Seq.empty }
,
...
libScalax.`binding.scala` ++= { if (djxIsScala212.value) Seq( """com.yang-bo""" %%% """html""" % """2.0.0+28-a2b9d520""") else Seq.empty }
,

libScalax.`binding.scala` ++= { if (djxIsScala212.value) Seq( """com.thoughtworks.binding""" %%% """binding""" % """12.1.0+110-53fd3428""") else Seq.empty }
,
...
libScalax.`sbt-librarymanagement` ++= { if (djxIsScala212.value) Seq( """org.scala-sbt""" %% """librarymanagement-core""" % """1.8.0""") else Seq.empty }
,

libScalax.`commons-lang3` ++= { if (djxIsScala212.value) Seq( """org.apache.commons""" % """commons-lang3""" % """3.12.0""") else Seq.empty }
,

libScalax.`simple-adt` ++= { if (djxIsScala212.value) Seq( """net.scalax.simple""" %%% """simple-adt""" % """0.0.1-M6""") else Seq.empty }
,

libScalax.`kind-projector` ++= { if (djxIsScala213.value) Seq( """org.typelevel""" % """kind-projector""" % """0.13.2""" cross CrossVersion.full) else Seq.empty }
,
...
libScalax.`zio2` ++= { if (djxIsScala213.value) Seq( """dev.zio""" %%% """zio""" % """2.0.9""") else Seq.empty }
,

libScalax.`zio2` ++= { if (djxIsScala213.value) Seq( """dev.zio""" %%% """zio-streams""" % """2.0.9""") else Seq.empty }
,

libScalax.`zio2` ++= { if (djxIsScala213.value) Seq( """dev.zio""" %%% """zio-test""" % """2.0.9""") else Seq.empty }
,

libScalax.`zio2` ++= { if (djxIsScala213.value) Seq( """dev.zio""" %%% """zio-test-sbt""" % """2.0.9""") else Seq.empty }
,

libScalax.`typesafe-config` ++= { if (djxIsScala213.value) Seq( """com.typesafe""" % """config""" % """1.4.2""") else Seq.empty }
,

libScalax.`scala-collection-compat` ++= { if (djxIsScala213.value) Seq( """org.scala-lang.modules""" %%% """scala-collection-compat""" % """2.9.0""") else Seq.empty }
,

libScalax.`http4s-Release` ++= { if (djxIsScala213.value) Seq( """org.http4s""" %%% """http4s-dsl""" % """0.23.17""") else Seq.empty }
,

libScalax.`http4s-Release` ++= { if (djxIsScala213.value) Seq( """org.http4s""" %%% """http4s-ember-server""" % """0.23.17""") else Seq.empty }
,

libScalax.`http4s-Release` ++= { if (djxIsScala213.value) Seq( """org.http4s""" %%% """http4s-ember-client""" % """0.23.17""") else Seq.empty }
,
...
libScalax.`binding.scala` ++= { if (djxIsScala213.value) Seq( """com.yang-bo""" %%% """html""" % """2.0.0+28-a2b9d520""") else Seq.empty }
,

libScalax.`binding.scala` ++= { if (djxIsScala213.value) Seq( """com.thoughtworks.binding""" %%% """binding""" % """12.1.0+110-53fd3428""") else Seq.empty }
,
...
libScalax.`commons-lang3` ++= { if (djxIsScala213.value) Seq( """org.apache.commons""" % """commons-lang3""" % """3.12.0""") else Seq.empty }
,

libScalax.`simple-adt` ++= { if (djxIsScala213.value) Seq( """net.scalax.simple""" %%% """simple-adt""" % """0.0.1-M6""") else Seq.empty }
,
...
libScalax.`zio2` ++= { if (djxIsScala3.value) Seq( """dev.zio""" %%% """zio""" % """2.0.9""") else Seq.empty }
,

libScalax.`zio2` ++= { if (djxIsScala3.value) Seq( """dev.zio""" %%% """zio-streams""" % """2.0.9""") else Seq.empty }
,

libScalax.`zio2` ++= { if (djxIsScala3.value) Seq( """dev.zio""" %%% """zio-test""" % """2.0.9""") else Seq.empty }
,

libScalax.`zio2` ++= { if (djxIsScala3.value) Seq( """dev.zio""" %%% """zio-test-sbt""" % """2.0.9""") else Seq.empty }
,

libScalax.`typesafe-config` ++= { if (djxIsScala3.value) Seq( """com.typesafe""" % """config""" % """1.4.2""") else Seq.empty }
,

libScalax.`scala-collection-compat` ++= { if (djxIsScala3.value) Seq( """org.scala-lang.modules""" %%% """scala-collection-compat""" % """2.9.0""") else Seq.empty }
,

libScalax.`http4s-Release` ++= { if (djxIsScala3.value) Seq( """org.http4s""" %%% """http4s-dsl""" % """0.23.17""") else Seq.empty }
,

libScalax.`http4s-Release` ++= { if (djxIsScala3.value) Seq( """org.http4s""" %%% """http4s-ember-server""" % """0.23.17""") else Seq.empty }
,

libScalax.`http4s-Release` ++= { if (djxIsScala3.value) Seq( """org.http4s""" %%% """http4s-ember-client""" % """0.23.17""") else Seq.empty }
,
...
libScalax.`binding.scala` ++= { if (djxIsScala3.value) Seq( """com.thoughtworks.binding""" %%% """binding""" % """12.1.0+110-53fd3428""") else Seq.empty }
,
...
libScalax.`commons-lang3` ++= { if (djxIsScala3.value) Seq( """org.apache.commons""" % """commons-lang3""" % """3.12.0""") else Seq.empty }
,
