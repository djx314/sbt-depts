...
object LibraryDeptsInstance extends _root_.djx.sbt.depts.abs.LibraryDepts {
  ...
  libraryDependencies += "org.tpolecat" %% "doobie-core" % "1.0.0-RC3"

  libraryDependencies += "org.tpolecat" %% "doobie-hikari" % "1.0.0-RC3"

  libraryDependencies += "org.tpolecat" %% "doobie-postgres" % "1.0.0-RC3"

  libraryDependencies += "org.tpolecat" %% "doobie-scalatest" % "1.0.0-RC3"

  VarContext.changeDeptVar := "doobie-h2"

  libraryDependencies += "org.tpolecat" %% "doobie-h2" % "1.0.0-RC3"
  ...
  libraryDependencies += "org.http4s" %%% "http4s-dsl" % "0.23.20"

  libraryDependencies += "org.http4s" %%% "http4s-circe" % "0.23.20"

  VarContext.changeDeptVar := "http4s-Release-ember-server"

  libraryDependencies += "org.http4s" %%% "http4s-ember-server" % "0.23.20"

  VarContext.changeDeptVar := "http4s-Release-ember-client"

  libraryDependencies += "org.http4s" %%% "http4s-ember-client" % "0.23.20"
