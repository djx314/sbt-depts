...
libraryDependencies += "dev.zio" %%% "zio-test"     % "2.1.25"
libraryDependencies += "dev.zio" %%% "zio-test-sbt" % "2.1.25"
...
libraryDependencies += "org.http4s" %%% "http4s-dsl"   % "0.23.34"

VarContext.changeDeptVar             := "http4s-Release-circe"
libraryDependencies += "org.http4s" %%% "http4s-circe" % "0.23.34"

VarContext.changeDeptVar             := "http4s-Release-ember-server"
libraryDependencies += "org.http4s" %%% "http4s-ember-server" % "0.23.34"
...
libraryDependencies += "org.scala-sbt" %% "librarymanagement-core" % "2.0.0-RC11"
...
libraryDependencies += "org.apache.pekko" %% "pekko-actor-typed"           % "1.5.0"
libraryDependencies += "org.apache.pekko" %% "pekko-stream-typed"          % "1.5.0"
libraryDependencies += "org.apache.pekko" %% "pekko-http"                  % "1.3.0"
libraryDependencies += "org.apache.pekko" %% "pekko-http-spray-json"       % "1.3.0"
libraryDependencies += "org.apache.pekko" %% "pekko-serialization-jackson" % "1.5.0"
libraryDependencies += "org.apache.pekko" %% "pekko-slf4j"                 % "1.5.0"

VarContext.changeDeptVar                  := "pekko-actor"
libraryDependencies += "org.apache.pekko" %% "pekko-actor" % "1.5.0"
...
libraryDependencies += "org.scala-sbt" %% "main" % "2.0.0-RC11"
