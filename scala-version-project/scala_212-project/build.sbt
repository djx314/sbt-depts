...
libraryDependencies += "dev.zio" %%% "zio-streams"  % "2.1.12"
libraryDependencies += "dev.zio" %%% "zio-test"     % "2.1.12"
libraryDependencies += "dev.zio" %%% "zio-test-sbt" % "2.1.12"
...
libraryDependencies += "com.caoccao.javet" % "javet" % "4.0.0"
...
libraryDependencies += "io.get-coursier" %% "coursier-core"  % "2.1.16"
libraryDependencies += "io.get-coursier" %% "coursier-cache" % "2.1.16"
