...
libraryDependencies += "dev.zio" %%% "zio-test"     % "2.1.13"
libraryDependencies += "dev.zio" %%% "zio-test-sbt" % "2.1.13"
...
libraryDependencies += "org.http4s" %%% "http4s-circe" % "0.23.29"

VarContext.changeDeptVar             := "http4s-Release-ember-server"
libraryDependencies += "org.http4s" %%% "http4s-ember-server" % "0.23.29"
...
libraryDependencies += "com.caoccao.javet" % "javet"                          % "4.1.0"
VarContext.changeDeptVar                  := "javet-node-linux-arm64"
libraryDependencies += "com.caoccao.javet" % "javet-node-linux-arm64"         % "4.1.0"
VarContext.changeDeptVar                  := "javet-node-linux-arm64-i18n"
libraryDependencies += "com.caoccao.javet" % "javet-node-linux-arm64-i18n"    % "4.1.0"
VarContext.changeDeptVar                  := "javet-node-linux-x86_64"
libraryDependencies += "com.caoccao.javet" % "javet-node-linux-x86_64"        % "4.1.0"
VarContext.changeDeptVar                  := "javet-node-linux-x86_64-i18n"
libraryDependencies += "com.caoccao.javet" % "javet-node-linux-x86_64-i18n"   % "4.1.0"
VarContext.changeDeptVar                  := "javet-node-macos-arm64"
libraryDependencies += "com.caoccao.javet" % "javet-node-macos-arm64"         % "4.1.0"
VarContext.changeDeptVar                  := "javet-node-macos-arm64-i18n"
libraryDependencies += "com.caoccao.javet" % "javet-node-macos-arm64-i18n"    % "4.1.0"
VarContext.changeDeptVar                  := "javet-node-macos-x86_64"
libraryDependencies += "com.caoccao.javet" % "javet-node-macos-x86_64"        % "4.1.0"
VarContext.changeDeptVar                  := "javet-node-macos-x86_64-i18n"
libraryDependencies += "com.caoccao.javet" % "javet-node-macos-x86_64-i18n"   % "4.1.0"
VarContext.changeDeptVar                  := "javet-node-windows-x86_64"
libraryDependencies += "com.caoccao.javet" % "javet-node-windows-x86_64"      % "4.1.0"
VarContext.changeDeptVar                  := "javet-node-windows-x86_64-i18n"
libraryDependencies += "com.caoccao.javet" % "javet-node-windows-x86_64-i18n" % "4.1.0"
VarContext.changeDeptVar                  := "javet-node-android"
libraryDependencies += "com.caoccao.javet" % "javet-node-android"             % "4.1.0"
VarContext.changeDeptVar                  := "javet-node-android-i18n"
libraryDependencies += "com.caoccao.javet" % "javet-node-android-i18n"        % "4.1.0"
VarContext.changeDeptVar                  := "javet-v8-linux-arm64"
libraryDependencies += "com.caoccao.javet" % "javet-v8-linux-arm64"           % "4.1.0"
VarContext.changeDeptVar                  := "javet-v8-linux-arm64-i18n"
libraryDependencies += "com.caoccao.javet" % "javet-v8-linux-arm64-i18n"      % "4.1.0"
VarContext.changeDeptVar                  := "javet-v8-linux-x86_64"
libraryDependencies += "com.caoccao.javet" % "javet-v8-linux-x86_64"          % "4.1.0"
VarContext.changeDeptVar                  := "javet-v8-linux-x86_64-i18n"
libraryDependencies += "com.caoccao.javet" % "javet-v8-linux-x86_64-i18n"     % "4.1.0"
VarContext.changeDeptVar                  := "javet-v8-macos-arm64"
libraryDependencies += "com.caoccao.javet" % "javet-v8-macos-arm64"           % "4.1.0"
VarContext.changeDeptVar                  := "javet-v8-macos-arm64-i18n"
libraryDependencies += "com.caoccao.javet" % "javet-v8-macos-arm64-i18n"      % "4.1.0"
VarContext.changeDeptVar                  := "javet-v8-macos-x86_64"
libraryDependencies += "com.caoccao.javet" % "javet-v8-macos-x86_64"          % "4.1.0"
VarContext.changeDeptVar                  := "javet-v8-macos-x86_64-i18n"
libraryDependencies += "com.caoccao.javet" % "javet-v8-macos-x86_64-i18n"     % "4.1.0"
VarContext.changeDeptVar                  := "javet-v8-windows-x86_64"
libraryDependencies += "com.caoccao.javet" % "javet-v8-windows-x86_64"        % "4.1.0"
VarContext.changeDeptVar                  := "javet-v8-windows-x86_64-i18n"
libraryDependencies += "com.caoccao.javet" % "javet-v8-windows-x86_64-i18n"   % "4.1.0"
VarContext.changeDeptVar                  := "javet-v8-android"
libraryDependencies += "com.caoccao.javet" % "javet-v8-android"               % "4.1.0"
VarContext.changeDeptVar                  := "javet-v8-android-i18n"
libraryDependencies += "com.caoccao.javet" % "javet-v8-android-i18n"          % "4.1.0"
...
libraryDependencies += "org.apache.pekko" %% "pekko-actor-typed"           % "1.1.2"
libraryDependencies += "org.apache.pekko" %% "pekko-stream-typed"          % "1.1.2"
libraryDependencies += "org.apache.pekko" %% "pekko-http"                  % "1.1.0"
libraryDependencies += "org.apache.pekko" %% "pekko-http-spray-json"       % "1.1.0"
libraryDependencies += "org.apache.pekko" %% "pekko-serialization-jackson" % "1.1.2"
libraryDependencies += "org.apache.pekko" %% "pekko-slf4j"                 % "1.1.2"
...
libraryDependencies += "io.get-coursier" %% "coursier-cache" % "2.1.20"
