...
libraryDependencies += "dev.zio" %%% "zio-test"     % "2.0.20"
libraryDependencies += "dev.zio" %%% "zio-test-sbt" % "2.0.20"
...
libraryDependencies += "org.http4s" %%% "http4s-ember-client" % "0.23.24"
...
libraryDependencies += "dev.zio" %%% "zio-config-yaml"       % "4.0.0"
libraryDependencies += "dev.zio" %%% "zio-config-derivation" % "4.0.0"
...
libraryDependencies += "com.typesafe.slick" %% "slick-hikaricp" % "3.5.0-M5"
libraryDependencies += "com.typesafe.slick" %% "slick-codegen"  % "3.5.0-M5"

VarContext.changeDeptVar               := "logback-classic"
libraryDependencies += "ch.qos.logback" % "logback-classic" % "1.4.14"

VarContext.changeDeptVar                  := "javet"
libraryDependencies += "com.caoccao.javet" % "javet" % "3.0.2"
