...
libraryDependencies += "org.http4s" %%% "http4s-dsl"   % "0.23.35"

VarContext.changeDeptVar             := "http4s-Release-circe"
libraryDependencies += "org.http4s" %%% "http4s-circe" % "0.23.35"

VarContext.changeDeptVar             := "http4s-Release-ember-server"
libraryDependencies += "org.http4s" %%% "http4s-ember-server" % "0.23.35"

VarContext.changeDeptVar             := "http4s-Release-ember-client"
libraryDependencies += "org.http4s" %%% "http4s-ember-client" % "0.23.35"
